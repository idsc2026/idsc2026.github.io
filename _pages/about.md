...
  <h2 style="font-weight: 900; font-size: 2.5em; background: linear-gradient(90deg, #00C9FF 0%, #92FE9D 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Will You Claim the 2026 Championship Title? 🏆</h2>
  <p style="font-size: 1.2em; line-height: 1.6; opacity: 0.9;">
    The ultimate arena is open. Hosted by <strong>UPM (Malaysia)</strong> in an epic alliance with <strong>UNAIR</strong>, <strong>UNMUL</strong>, and <strong>UB (Indonesia)</strong>, this global, fully-online competition is your chance for glory. Challenge the best, bring the international trophy home to your country, and make your university proud. Prove that math, data, and code can change the world!
  </p>
</div>
...
We believe math isn't just numbers on a whiteboard—it's the ultimate toolkit for finding hope hidden in the data. Your directive? **Mathematics for Hope in Healthcare**. You will tackle real-world clinical dilemmas using cutting-edge machine learning, deep learning, and advanced statistical modeling to rise above the competition.

### 💻 The Challenge: Code to Save Lives
Step into the shoes of an AI clinician! Healthcare impact often depends on spotting risk patterns in physiological signals and medical imaging before a human eye can. But biomedical data is messy, noisy, and highly sensitive. Your challenge is to build models that aren't just highly accurate, but transparent, reproducible, and actually useful in the real world. Show the judges you have what it takes to innovate.

**The Dataset Directives:** Teams must use **at least one** of the official datasets listed below, hosted directly on [PhysioNet](https://physionet.org/). *External labeled datasets are strictly prohibited.* Everyone fights in the same arena, regardless of the dataset you pick. Choose wisely.
...
**Your Winning Payload (Deliverables):**
* 🛠️ **The Method:** A validated, championship-tier pipeline with strict train/val/test splits.
...
    <p style="margin-top: 0; font-size: 0.9em; opacity: 0.8;">Fight for the RM 1,000.00 Total Payload!</p>
    <ul style="list-style-type: none; padding-left: 0; font-size: 1.1em;">
      <li style="margin-bottom: 8px;">🥇 <strong>Champion:</strong> RM 500.00 + Ultimate Glory</li>
...
    <h3 style="margin-top: 0; color: #92FE9D;">🌟 Challenger Perks</h3>
    <p style="margin-top: 0; font-size: 0.9em; opacity: 0.8;">For all registered squads brave enough to compete.</p>
    <ul style="list-style-type: none; padding-left: 0; font-size: 1.1em;">
      <li style="margin-bottom: 8px;">📜 <strong>E-Certificates:</strong> Official proof of your grind.</li>
      <li style="margin-bottom: 8px;">💡 <strong>Exclusive Workshops (with E-Cerificates):</strong> Level up your data science and pitching skills with industry pros to prepare you for battle.</li>
    </ul>
  </div>
</div>
