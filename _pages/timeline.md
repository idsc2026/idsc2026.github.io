...
      <br><span style="font-size: 0.9em; opacity: 0.8;">The portal opens! Team registration begins and the official <strong>PhysioNet datasets</strong> are ready for exploration.</span>
    </li>
...
  <p><strong>14 March 2026: Intl. Mathematics Day & Workshops</strong></p>
  <ul style="font-size: 0.9em; opacity: 0.9;">
    <li>⚡ <strong>AM Session:</strong> <em>Data Science / Machine Learning Workshop</em> with Assoc. Prof. Dr. Shukor Sanim Mohd Fauzi (UiTM).</li>
    <li>🎙️ <strong>PM Session:</strong> <em>Presentation Skills Workshop</em> with Dr. Ghazila Binti Ghazi (UPM).</li>
    <li>🛠️ <strong>Plus:</strong> A deep-dive technical briefing on tackling the PhysioNet biomedical datasets.</li>
  </ul>
</div>
...
    <li>📄 <strong>Tech Report:</strong> Your methodology, data preprocessing, and clinical insights (Max 5 pages).</li>
    <li>🎥 <strong>Video Pitch:</strong> A 3-minute summary explaining how your solution brings "Hope in Healthcare".</li>
...
      <br><span style="font-size: 0.9em; opacity: 0.8;">The joint UPM, UNAIR, UNMUL, and UB panel—joined by healthcare and AI industry experts—hunts for technical rigor and clinical relevance.</span>
    </li>
...
    <li>🎤 <strong>Live Pitches:</strong> The Top 5 teams face our international judging panel (10 mins presentation + 5 mins Q&A).</li>
