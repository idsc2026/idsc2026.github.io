...
After an incredible journey of mathematics, code, and data-driven innovation, the **International Data Science Challenge (IDSC) 2026** has officially come to a close! We want to thank every single brilliant mind from across the globe who stepped up to bring tangible hope to healthcare. 🌍💡

Below are the final results of the competition. 

---

### 🌟 Final Stage: Top 10 Champions
...
### 📊 Stage 1: Full Rankings

We were blown away by the caliber of submissions during Stage 1. Whether you made it to the finals or not, your hard work has truly set a high benchmark for future challenges. 

<div style="background: rgba(146, 254, 157, 0.1); border-left: 5px solid #92FE9D; padding: 20px; border-radius: 8px; margin: 25px 0;">
  <p style="margin: 0; font-size: 1.05em;"><strong>Note:</strong> The Stage 1 ranking document includes the scores for all participating teams. Please use your Team ID to locate your standing.</p>
</div>
