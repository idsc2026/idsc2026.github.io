...
<div style="text-align: center; margin: 25px 0;">
  <p style="font-size: 1.1em; margin-bottom: 15px;"><em>Need the official paperwork? Download the clean, exquisite PDF copy of this debrief report below:</em></p>
  <a href="https://drive.google.com/file/d/1q8eOVHFznVXW-rbq4XhbLV_yEborY3D6/view?usp=sharing" target="_blank" style="display: inline-block; padding: 15px 35px; font-size: 1.1em; color: #fff; background: linear-gradient(90deg, #00C9FF 0%, #92FE9D 100%); border-radius: 50px; text-decoration: none; font-weight: bold; box-shadow: 0 8px 15px rgba(0, 201, 255, 0.25); text-transform: uppercase; letter-spacing: 0.5px;">
